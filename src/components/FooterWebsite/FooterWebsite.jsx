            ...
            <div className="footer_content">
                <div className="footer_content_int" >
                    <div className="footer_links">
                        <h2>Links</h2>
                        <div>
                            <Link to={"#"}><BsFillCaretRightFill/> Sobre</Link>
                            <Link to={"#"}><BsFillCaretRightFill/> Contato</Link>
                            <Link to={"#"}><BsFillCaretRightFill/> Políticas</Link>
                            <Link to={"#"}><BsFillCaretRightFill/> Termos e Condições</Link>
                            <Link to={"#"}><BsFillCaretRightFill/> FAQ & Ajuda</Link>
                        </div>
                    </div>
                    <div className="footer_contato">
                        <h2>Contato</h2>
                        <div>
                            <p><FaLocationArrow/> Avenida Paulista Nº 800 São Paulo, SP.</p>
                            <p><FaPhoneAlt/> 0800 000 800</p>
                            <p><FaMailBulk/> info@myedu.com.br</p>
